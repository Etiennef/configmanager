...
class PluginConfigmanagerRule extends PluginConfigmanagerCommon {
    ...
    static protected final function showFormStatic($type, $type_id) {
        ...
        if($can_write) {
            echo '<tr>';
            echo '<td class="center"><a class="pointer" onclick="'.$rootid.'.addlast()"><img src="'.$CFG_GLPI['root_doc'].'/pics/menu_add.png" title=""></a></td>';
    ...
    private static final function makeRuleTablerow($rule, $rootid, $can_write) {
        ...
        if($can_write) {
            ...
            $output .= '<td><a class="pointer" onclick="'.$rootid.'.moveup(\''.$rule['id'].'\')"><img src="'.$CFG_GLPI['root_doc'].'/pics/deplier_up.png" title=""></a></td>';
            $output .= '<td><a class="pointer" onclick="'.$rootid.'.movedown(\''.$rule['id'].'\')"><img src="'.$CFG_GLPI['root_doc'].'/pics/deplier_down.png" title=""></a></td>';
            $output .= '<td><a class="pointer" onclick="'.$rootid.'.add(\''.$rule['id'].'\')"><img src="'.$CFG_GLPI['root_doc'].'/pics/menu_add.png" title=""></a></td>';
            $output .= '<td><a class="pointer" onclick="'.$rootid.'.remove(\''.$rule['id'].'\')"><img src="'.$CFG_GLPI['root_doc'].'/pics/reset.png" title=""></a></td>';
            $output .= '</table></tr>';
        } else {
